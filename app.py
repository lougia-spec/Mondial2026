...
DERNIERE_MAJ = "08/12/2025 à 19:00"
...
with st.sidebar:
    ...
    st.markdown("---")
    st.write("### 📜 Les Règles")
    st.info("👋 **Victoire / Défaite**")
    st.write("* **1 pt** : Bon vainqueur")
    st.write("* **3 pts** : Score exact")
    st.info("🤝 **Match Nul**")
    st.write("* **1 pt** : Nul trouvé (ex: 1-1 vs 0-0)")
    st.write("* **3 pts** : Nul exact (ex: 2-2 vs 2-2)")
