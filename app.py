...
MATCHS = [
    ...
    {"id": 27, "date": "2026-06-20", "heure": "19h", "groupe": "Groupe E", "eqA": "🇩🇪 Allemagne", "eqB": "🇨🇼 Curaçao", "scA": None, "scB": None},
    ...
    {"id": 69, "date": "2026-06-23", "heure": "22h", "groupe": "Groupe L", "eqA": "🏴󠁧󠁢󠁥󠁮󠁧󠁿 Angleterre", "eqB": "🇭🇷 Croatie", "scA": None, "scB": None},
...
with st.sidebar:
    ...
    st.markdown("---")
    st.write(f"🕒 **MàJ :C'est vraiment frustrant, et je comprends ta lassitude ! C'est le problème récurrent des copier-coller longs sur téléphone : la sélection se coupe et le code arrive incomplet sur GitHub.

Je te redonne le code de la version précédente. Pour que cet essai soit le bon, nous devons impérativement changer de méthode :

### La Stratégie Infaillible pour Réussir 🎯

1.  **Sur ton téléphone, ne sélectionne pas le texte manuellement.**
2.  Dans le bloc noir ci-dessous, cherche **le petit bouton "Copier"** (l'icône avec deux rectangles superposés qui apparaît souvent en haut à droite). **Clique dessus**. C'est le seul moyen d'être sûr de copier la totalité du code sans aucun raté.
3.  Sur GitHub, dans ton fichier `app.py`, fais "Tout sélectionner", efface tout, et colle le code intact.

👉 **Voici le code complet, intact et vérifié :**
...
.stApp {
    ...
    background: linear-gradient(rgba(255, 255, 255, 0.88), rgba(255, 255, 255, 0.88)), url("[https://images.unsplash.com/photo-1518605368461-1e1c9e1d0092?auto=format&fit=crop&q=80&w=2000](https://images.unsplash.com/photo-1518605368461-1e1c9e1d0092?auto=format&fit=crop&q=80&w=2000)");
    background-size: cover;
    background-position: center;
    background-attachment: fixed;
}
...
LIEN_WHATSAPP = "[https://chat.whatsapp.com/LOgrgmIAqgy7m9PBpDsaf9?mode=wwt](https://chat.whatsapp.com/LOgrgmIAqgy7m9PBpDsaf9?mode=wwt)"
LIEN_CAGNOTTE = "[https://paypal.me/mickaelBerault?locale.x=fr_FR&country.x=FR](https://paypal.me/mickaelBerault?locale.x=fr_FR&country.x=FR)"
# 👆 ---------------------------- 👆
...
with st.sidebar:
    st.image("[https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/FIFA_World_Cup_2026_Logo.svg/1024px-FIFA_World_Cup_2026_Logo.svg.png](https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/FIFA_World_Cup_2026_Logo.svg/1024px-FIFA_World_Cup_2026_Logo.svg.png)", width=200)
    st.title("⚽ Mondial 2026")
